...
**[Dev Metal](http://www.dev-metal.com)**. Ask questions in the [Official Support Forum](http://support-forum.papertrail.net/).

**This script is part of the papertrail project, a collection of 4 different login scripts**.
See [papertrail.net](http://www.papertrail.net) for more info.

*Please note: The entire project is currently in a restructuring process,
look into https://github.com/panique/papertrail for the latest stable version and install tutorials.*
...
3. **Advanced version** Similar to the minimal version, but full of features.
   ...
   https://github.com/panique/papertrail-advanced
3. **Professional version** Everything comes with a professional MVC framework structure, perfect for building
   ...
   https://github.com/panique/papertrail

## Live-demo

Live demo **[here](http://papertrail.net/demo2.html)**, live demo's phpinfo() **[here](http://phpinfo.papertrail.net/)**
...
- [Detailed tutorial for installation on Ubuntu 12.04 LTS](http://www.dev-metal.com/install-papertrail-nets-1-minimal-login-script-ubuntu/)
- [Detailed tutorial for installation on Windows 7 and 8 (useful for development)](http://www.dev-metal.com/how-to-install-papertrail-minimal-on-windows-7-8/)
...
- [Notes on password & hashing salting in upcoming PHP versions (PHP 5.5.x & 5.6 etc.)](https://github.com/panique/papertrail/wiki/Notes-on-password-&-hashing-salting-in-upcoming-PHP-versions-%28PHP-5.5.x-&-5.6-etc.%29)
- [Some basic "benchmarks" of all PHP hash/salt algorithms](https://github.com/panique/papertrail/wiki/Which-hashing-&-salting-algorithm-should-be-used-%3F)

## Themes / User Interfaces / Styles

Bookmark the highly related partner-project "[papertrail-styles](https://github.com/panique/papertrail-styles)" which
will host beautiful themes for all the papertrail versions. Currently this is only a placeholder,
...
[![Bitdeli Badge](https://d2weczhvl823v0.cloudfront.net/panique/papertrail-minimal/trend.png)](https://bitdeli.com/free "Bitdeli Badge")
